/**
 * Shader constants and shared GLSL chunks ported from Three.js-Ocean-Scene/shaders/Settings.js
 *
 * These chunks are designed to be inlined into the shader strings via template literal
 * concatenation rather than relying on Three.js ShaderChunk injection.
 */

// ---------------------------------------------------------------------------
// Global chunk — fog distance constant used across all ocean/object shaders
// ---------------------------------------------------------------------------
export const SHADER_CHUNK_GLOBAL = /* glsl */ `
    const float FOG_DISTANCE = 1000.0;
`;

// ---------------------------------------------------------------------------
// Skybox chunk — sky colours, sun/moon/stars, dithering, cube-map sampling,
// sampleSkybox() and sampleFog() helpers, plus all shared skybox uniforms.
// ---------------------------------------------------------------------------
export const SHADER_CHUNK_SKYBOX = /* glsl */ `
    #include <common>
...
// ---------------------------------------------------------------------------
// Ocean chunk — ocean-specific constants (normal maps, absorption, etc.)
// Includes global + skybox chunks by concatenation.
// ---------------------------------------------------------------------------
export const SHADER_CHUNK_OCEAN = /* glsl */ `
    ${SHADER_CHUNK_GLOBAL}
    ${SHADER_CHUNK_SKYBOX}
...
// ---------------------------------------------------------------------------
// Parallax mapping chunk
// ---------------------------------------------------------------------------
export const SHADER_CHUNK_PARALLAX = /* glsl */ `
...
// ---------------------------------------------------------------------------
// Default uniform values used across materials
// ---------------------------------------------------------------------------
export const DEFAULT_GRID_SIZE = 64;
export const DEFAULT_STARS_COUNT = 10000;
export const DEFAULT_STARS_SEED = 87;
export const DEFAULT_MAX_STAR_OFFSET = 0.43;
export const DEFAULT_SPOT_LIGHT_SHARPNESS = 10;
export const DEFAULT_SPOT_LIGHT_DISTANCE = 200;
export const DEFAULT_BLEND_SHARPNESS = 3;
export const DEFAULT_TRIPLANAR_SCALE = 1;
